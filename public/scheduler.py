...
# 添加一个定时任务
scheduler.add_job(stock, trigger='cron', hour="21,8,5", minute="*", args=[True], id="desire_job2", replace_existing=True)
scheduler.add_job(shares, trigger='interval', seconds=60 * 5, id="desire_job1", replace_existing=True)
